  ...
  attachments: [
    {
      ...
      content: {
        ...
        version: "1.4",
        body: [
          { type: "TextBlock", text: "🎛 aigle Control Panel", weight: "Bolder", size: "Large", color: "Accent" },
          { type: "TextBlock", text: "Canlı sprint verisini kanala çekmek için bir butona bas.", wrap: true, isSubtle: true },
        ],
        actions: [
          { type: "Action.OpenUrl", title: "🎯 Özet",   url: `${baseUrl}/api/teams-query?type=summary` },
          { type: "Action.OpenUrl", title: "📅 Sprint", url: `${baseUrl}/api/teams-query?type=sprint` },
          { type: "Action.OpenUrl", title: "📝 Görevler", url: `${baseUrl}/api/teams-query?type=tasks` },
          { type: "Action.OpenUrl", title: "👥 Takım",  url: `${baseUrl}/api/teams-query?type=team` },
        ],
      },
    },
  ],
