...
import { healthScore, velocityTrend } from "../../lib/mockData";

type Props = { onRoast: () => void; onNewPlanning: () => void };

export function Dashboard({ onRoast, onNewPlanning }: Props) {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" onClick={onRoast}>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        <MetricCard
          label="Velocity"
          value="42 SP"
          delta={{ direction: "up", text: "+8 vs avg" }}
          icon={Gauge}
        />
        <MetricCard
          label="Done"
        ...
        <MetricCard
          ...
          value="13%"
          sub="3 tasks"
          delta={{ direction: "down", text: "-4 vs prev" }}
          icon={AlertCircle}
        />
      ...
      <Card>
        ...
        <CardContent>
          <div style={{ width: "100%", height: 280 }}>
            <ResponsiveContainer>
              <LineChart data={velocityTrend} margin={{ top: 10, right: 20, bottom: 0, left: -10 }}>
