...
import { plannedVsDone, reviewNarrative } from "../../lib/mockData";

type Props = { onRoast: () => void };

export function Review({ onRoast }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_1fr]">
        <Card>
          <CardHeader>
            <CardTitle>Planned vs Done</CardTitle>
          </CardHeader>
          <CardContent>
            <div style={{ width: "100%", height: 260 }}>
              <ResponsiveContainer>
                <BarChart data={plannedVsDone} margin={{ top: 10, right: 10, bottom: 0, left: -10 }}>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <Button variant="destructive" onClick={onRoast}>
